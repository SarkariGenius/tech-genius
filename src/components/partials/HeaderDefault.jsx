                ...
                <Container fluid className="container-fluid p-lg-0">
                  ...
                  >
                    <Nav.Item as="li">
                      ...
                      <Collapse in={open1} className="sub-nav list-unstyled">
                        ...
                        <Nav.Item as="li">
                            <Link
                              to="/all-walkIn"
                              className={`${location.pathname === "/all-walkIn" ||
                                location.pathname === "/all-walkIn"
                                ? "active"
                                : ""
                                } nav-link`}
                    ...
                    <Nav.Item as="li">
                      ...
                      >
                        <span className="item-name">{t("header.offers")}</span>
                        <span className="menu-icon ms-2">
                          <i
                            className="fa fa-caret-down toggledrop-desktop right-icon"
                            aria-hidden="true"
                    ...
                    <Nav.Item as="li">
                      ...
                      >
                        <span className="item-name">{t("header.about_us")}</span>
                        <span className="menu-icon ms-2">
                          <i
                            className="fa fa-caret-down toggledrop-desktop right-icon"
                            aria-hidden="true"
